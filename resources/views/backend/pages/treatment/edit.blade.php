            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="treat_title" id="Title"
                               placeholder="Enter Title" value="{{$treatment->treat_title}}">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <img class="mt-2" src="{{asset($treatment->treat_img)}}" alt="image" style="width: 120px" />
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="treat_desc" id="">{{$treatment->treat_desc}}</textarea>
                    </div>
                </div>
