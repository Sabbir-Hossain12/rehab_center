            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$slider->slider_title}}" name="slider_title" id="Title" placeholder="Enter Title">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <img src="{{asset($slider->slider_img)}}" style="width: 80px "/>
                    </div>
                </div>

                <div class="col-md-12" style="color: #0a0e14">
                    <label for="summernote">Description</label>
                    <textarea class="" id="summernote" name="slider_desc">{{$slider->slider_desc}}</textarea>
                </div>
