    ...
    <form method="POST" action="{{ route('blog.update', $blog->id) }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" value="{{ $blog->title }}" id="Title" placeholder="Enter Title">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="file" value="{{ $blog->thumbnail }}" name="thumbnail" id="Thumbnail">
            ...
            <div class="form-group" style="color: #0a0e14">
                ...
                <textarea class="" id="summernote" name="description">{{ $blog->long_desc }}</textarea>
            </div>
